namespace SmartInsure.Application.UseCase.UseCases.InsurerEnablementUseCases.CreateInsurerEnablement.Requests;
...
public sealed record CreateInsurerEnablementRequest(
    Guid BrokerageId,
    Guid InsurerId,
