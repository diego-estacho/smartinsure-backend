...
/// Cotações Prontas para emissão e as em Análise de subscrição (Quotation.IsFollowable); as demais são
    ...
    IUnitOfWork unitOfWork) : ISelectQuotationUseCase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // RN-059: só Pronta para emissão ou Análise de subscrição são seguíveis; as demais não são selecionáveis.
