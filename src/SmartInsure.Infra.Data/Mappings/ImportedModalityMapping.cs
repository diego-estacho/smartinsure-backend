...
public sealed class ImportedModalityMapping : IEntityTypeConfiguration<ImportedModality>
{
    public void Configure(EntityTypeBuilder<ImportedModality> builder)
    {
        ...
        // RN-033: reencontro por (Seguradora, identificador de origem). RN-035: busca pelo id da Modalidade Global.
        ...
        // RN-035/RN-037: vínculo direto com a Modalidade (Restrict por convenção global, ADR-034).
