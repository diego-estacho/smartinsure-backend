...
public sealed class BrokerageInsurerEnablementMapping : IEntityTypeConfiguration<BrokerageInsurerEnablement>
{
    public void Configure(EntityTypeBuilder<BrokerageInsurerEnablement> builder)
    {
        builder.ToTable("BrokerageInsurerEnablements");
        ...
        // Alinhado 1:1 com a migration criar-tabela-brokerage-insurer-enablements (evitar drift de constraint).
