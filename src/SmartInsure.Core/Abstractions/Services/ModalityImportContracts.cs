...
/// <summary>
/// Contrato do Motor de Cálculo para importação de modalidades (RN-034). Tipos do domínio/contrato,
...
/// <summary>Catálogo de uma Seguradora no retorno do motor; `IsSuccess` isola a falha por Seguradora (RN-038).</summary>
