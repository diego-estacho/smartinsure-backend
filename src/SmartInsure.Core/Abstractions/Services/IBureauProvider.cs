...
/// <summary>
/// Contrato do Birô (glossário) — implementado na camada de integração.
...
{
    /// <summary>
    /// Consulta os dados cadastrais do CPF/CNPJ no birô informado.
    ...
    /// <param name="bureau">Birô homologado que responde a consulta.</param>
