...
/// <summary>
/// Vínculo ativo Modalidade → Seguradora (RN-036): uma linha por Modalidade Importada Ativa,
...
/// <summary>
/// Pendência da Fila de Revisão (RN-037): Modalidade Importada Ativa, não Ignorada, sem vínculo
