...
| [ADR-060](060-catalogo-modalidades-dois-mundos.md) | Catálogo de Modalidades — dois mundos ligados por mapeamento | accepted | dominio, integracoes | Modalidade curada × Modalidade Importada da fonte, ligadas por mapeamento; catálogo curado-não-descoberto; importação idempotente por Seguradora resolvida pela Habilitação; nada opera sem mapeamento confirmado; preservação por inativação |
