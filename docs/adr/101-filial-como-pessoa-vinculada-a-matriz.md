...
# ADR-101: Filial como Pessoa vinculada à matriz, e estabelecimento cotado no Grupo de Cotação

## Status

Aceito (2026-07-27, AB#0005). Formaliza a modelagem exigida pela RN-101 e pela RN-102.
...
A demanda AB#0005 exige (RN-101) que a Filial seja cadastrada e **obrigatoriamente vinculada à matriz**, e
(RN-102) que o Grupo de Cotação registre qual estabelecimento é o objeto da garantia.
...
- Importação em cadeia (RN-101): CNPJ de Filial resolve a matriz, importa a matriz quando ausente, importa a
...
Decidido em 2026-07-28 (OPEN-90), e vale como orientação para quem desmockar as etapas de cotação e emissão:
...
Fica em aberto (OPEN-90): Nomeação por estabelecimento e remoção/desvínculo de Filial.
