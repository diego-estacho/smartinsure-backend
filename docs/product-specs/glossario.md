...
| **Pessoa Jurídica** | `LegalEntity` | Empresa identificada por CNPJ, cadastrada uma única vez na plataforma e reaproveitada pelos papéis que a referenciam (proposto em 2026-07-16 — aguardando ratificação da PO) | 1 por CNPJ | a Corretora e a Seguradora (têm cadastros próprios) |
| **Segurado** | `Insured` | Papel da Pessoa Jurídica protegida pela apólice em uma oferta (proposto em 2026-07-16 — aguardando ratificação da PO) | — | o tomador |
| **Tomador** | `PolicyHolder` | Papel da Pessoa Jurídica que contrata o seguro em uma oferta; é sempre a matriz (proposto em 2026-07-16 — aguardando ratificação da PO) | — | o segurado; uma filial |
