...
| **Pessoa** | `Person` | Pessoa física ou jurídica identificada por CPF/CNPJ, cadastrada uma única vez na plataforma e reaproveitada pelos papéis que a referenciam (proposto em 2026-07-16 — aguardando ratificação da PO) | 1 por CPF/CNPJ | a Corretora e a Seguradora (têm cadastros próprios); o Usuário |
