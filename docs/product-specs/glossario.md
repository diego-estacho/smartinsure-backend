...
| **Bureau** | `Bureau` | Serviço externo que fornece dados cadastrais públicos de pessoa ou empresa a partir do CPF/CNPJ (proposta — aguardando ratificação da PO) | — | fonte interna de dados; a seguradora |
