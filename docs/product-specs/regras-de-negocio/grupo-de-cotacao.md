...
**Casos limite.** Filial inexistente, ou vinculada a outra matriz que não o Tomador do grupo: recusada — a validação de vínculo é do servidor. Troca do Tomador do Grupo de Cotação: o estabelecimento cotado é limpo e volta a ser a matriz. Grupo de Cotação criado antes desta regra permanece válido, com a matriz como estabelecimento cotado. Qual CNPJ é efetivamente enviado à Seguradora ao cotar depende da etapa de cotações, que segue mockada e em aberto ([OPEN-07](../open-decisions.md), [OPEN-17](../open-decisions.md)).
