...
**Casos limite.** Modalidade sem nenhuma cobertura disponível: a etapa não oferece nenhuma e o Grupo segue válido sem coberturas. Cobertura escolhida cuja canônica é inativada depois: permanece registrada no Grupo e é tratada no envio (RN-105/RN-106). As Coberturas Adicionais são dado-base (RN-051/RN-060): alterá-las num Grupo **sem** Cotações é editado no lugar; num Grupo **com** Cotações obtidas, cria um Grupo novo, preservando o anterior. Grupo de Cotação criado antes desta regra permanece válido, com as coberturas que registrava.
