...
**Casos limite.** Filial inexistente, ou vinculada a outra matriz que não o Tomador do grupo: recusada — a validação de vínculo é do servidor. Troca do Tomador do Grupo de Cotação: o estabelecimento cotado é limpo e volta a ser a matriz. O estabelecimento cotado é dado-base (RN-060): trocar ou desmarcar a Filial num Grupo **sem** Cotações é editado no lugar (RN-051); num Grupo **com** Cotações obtidas, cria um Grupo novo, preservando o anterior. Grupo de Cotação criado antes desta regra permanece válido, com a matriz como estabelecimento cotado. **Limite de Crédito e taxa são sempre da matriz**, marcada ou não uma Filial: a Seguradora não consulta limite pelo CNPJ da Filial — a escolha do estabelecimento não altera os limites apresentados (RN-029). Que a Seguradora avalie o risco com base na matriz é funcionamento interno dela; a plataforma envia o estabelecimento cotado. A **emissão** pelo CNPJ do estabelecimento segue fora de escopo, na demanda da etapa de emissão ([OPEN-07](../open-decisions.md)).

## RN-104 — Coberturas Adicionais escolhidas no Grupo de Cotação

**Descrição.** O Grupo de Cotação registra quais Coberturas Adicionais o corretor escolheu, sempre pela Cobertura Adicional canônica — nunca pelo nome com que cada Seguradora a expõe. A etapa de risco oferece as canônicas Ativas disponíveis em ao menos uma Seguradora habilitada da Corretora do Escopo ativo para a Modalidade escolhida; a disponibilidade é derivada dos vínculos ativos, nunca digitada (RN-046).

**Pré-condições.** Jornada de nova oferta na etapa de risco, com Modalidade escolhida. Catálogo de Coberturas Adicionais canônicas e Importadas alimentado, com vínculos (RN-040/RN-041/RN-043/RN-046).

**Critério de aceitação.** Concluída a etapa de risco, o Grupo de Cotação registra o conjunto de Coberturas Adicionais canônicas marcadas, sem repetição — marcar a mesma cobertura duas vezes é a mesma escolha. A oferta lista apenas canônicas Ativas que tenham ao menos uma Cobertura Adicional Importada Ativa vinculada, numa Modalidade Importada Ativa e não Ignorada vinculada à Modalidade do Grupo, pertencente a Seguradora **Ativa no catálogo** e com Habilitação Ativa da Corretora do Escopo ativo (RN-103) — inativar a Seguradora não desativa as Habilitações, e o envio recusa Seguradora inativa, então ofertar por Habilitação apenas exibiria cobertura inalcançável. Trocar a Modalidade do Grupo descarta as coberturas escolhidas, porque a disponibilidade depende dela. Ao retomar um Grupo em Rascunho, as coberturas escolhidas voltam marcadas.

**Casos limite.** Modalidade sem nenhuma cobertura disponível: a etapa não oferece nenhuma e o Grupo segue válido sem coberturas. Acesso **sem Corretora ativa**: a etapa também não oferece nenhuma, porque a disponibilidade é derivada das Seguradoras habilitadas da Corretora do Escopo ativo — ausência de Escopo é estado legítimo, não erro; a recusa por falta de Escopo é da solicitação de Cotações (RN-103). Cobertura escolhida cuja canônica é inativada depois: permanece registrada no Grupo e é tratada no envio (RN-105/RN-106). As Coberturas Adicionais são dado-base (RN-051/RN-060): alterá-las num Grupo **sem** Cotações é editado no lugar; num Grupo **com** Cotações obtidas, cria um Grupo novo, preservando o anterior. Grupo de Cotação criado antes desta regra permanece válido, com as coberturas que registrava.
